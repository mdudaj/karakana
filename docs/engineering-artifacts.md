...
Version: 0.1. Status: P01–P05 local implementation delivered for review.
...
adds catalogue pointers and optional project choices. [P05 controlled pilots](skills/engineering-artifact-catalogue/P05.md)
exercise authoring, audience sharing and feedback. Independent review, realistic
project application and integration remain pending; existing approval rules apply.
