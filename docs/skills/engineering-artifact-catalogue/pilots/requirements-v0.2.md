...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DOC-REQ | document | Reader need and criteria | draft | unconfirmed | requirements-v0.2.md | context | 0.2 |  | Authored Markdown |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AC-01 | Catalogue has category review and category planning | Reader filters review | Only ITEM-01 is shown; stable item ID and title are visible | Exact case-sensitive match including whitespace; review matches ITEM-01, Review and review-with-trailing-space match no items | Fixture-driven functional test plus actual user walkthrough | STORY-01 | unconfirmed |
...
| --- | --- | --- | --- | --- | --- | --- |
| TC-01 | AC-01 | Reader prototype and runtime selected | Open catalogue.json; filter review, Review and review with a trailing space; inspect item IDs/titles | review shows only ITEM-01; Review and review with a trailing space show no items | Planned fixture check; no implementation | unconfirmed |
...
## Reviewed pilot amendment

The returned feedback asks whether whitespace is ignored. The brief already defines
exact matching including whitespace, so this bounded amendment clarifies AC-01 and
TC-01. It is an author self-review in the authorized synthetic pilot, not a product
decision or imported workbook agreement. The original 0.1 source and its exports are
retained; all source IDs persist and product cases remain Not run/Blocked.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CHANGE-01 | DOC-REQ | 0.1 | 0.2 | Clarify exact filter including whitespace; retain AC-01/TC-01 IDs; prior acceptance still unconfirmed | Codex pilot author | self-review only; no stakeholder approval |  | See README.md review exercise |
